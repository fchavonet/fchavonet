...
After an unconventional and varied career path, I am now fully dedicated to Software Engineering.

I completed an intensive training program at [Holberton School](https://www.holbertonschool.fr/) in Toulouse, followed by a work-study program where I worked as a Software Engineer Coach. Before the end of my apprenticeship, I was offered a full-time position and now continue in this role on the Dijon campus.

This journey allowed me to build strong technical foundations while developing autonomy, problem-solving skills, and a deep understanding of how to learn effectively.

Today, I continue to grow as a Software Engineer, contributing to meaningful projects while supporting others in their learning journey.
